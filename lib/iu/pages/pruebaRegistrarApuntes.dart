...
class RegistrarApuntes extends StatefulWidget {
  const RegistrarApuntes({super.key});

  @override
  State<RegistrarApuntes> createState() => _RegistrarApuntesState();
}

class _RegistrarApuntesState extends State<RegistrarApuntes> {
